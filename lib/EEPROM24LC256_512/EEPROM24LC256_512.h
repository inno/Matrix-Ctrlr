...
public:
	...
	void readPage(unsigned int page_number, unsigned char* data);
	void writePage(unsigned int page_number, unsigned char* data);
    void writePageFast(unsigned int page_number, unsigned char* data);
...
private:
    ...
    void writeMiniBufferFast(unsigned int addr);
